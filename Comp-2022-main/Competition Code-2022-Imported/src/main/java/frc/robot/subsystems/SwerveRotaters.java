...
public class SwerveRotaters extends SubsystemBase {
  ...
  public void resetEncoders() {
    ...
    fRRotater.setSelectedSensorPosition(0, 0, 20);
    fLRotater.setSelectedSensorPosition(0, 0, 20);
    bLRotater.setSelectedSensorPosition(0, 0, 20);
    bRRotater.setSelectedSensorPosition(0, 0, 20);
    System.out.println(fRRotater.getSelectedSensorPosition());
  }
