...
public class SwerveSpinners extends SubsystemBase {
  ...
  public static final double SPEED_MULTIPLIER = 0.48;
  ...
  public void resetEncoders() {
    System.out.println(fRMotor.getSelectedSensorPosition());
    fRMotor.setSelectedSensorPosition(0, 0, 20);
    fLMotor.setSelectedSensorPosition(0, 0, 20);
    bLMotor.setSelectedSensorPosition(0, 0, 20);
    bRMotor.setSelectedSensorPosition(0, 0, 20);
    System.out.println(fRMotor.getSelectedSensorPosition());
  }
